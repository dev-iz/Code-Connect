...
function Sidebar() {
    ...
    return (
        <aside className="flex w-full md:h-full md:max-h-full md:min-h-full min-w-auto">
            <div
                className={cn(
            ...
            >
                ...
                <SidebarButton
                    ...
                    icon={viewIcons[VIEWS.VIDEO_CHAT]}
                />
            ...
            <div
                className="absolute left-0 top-0 z-20 w-full flex-col bg-dark md:static md:max-w-full"
